...
var app = (function () {
    ...
    /* src\Products\Product.svelte generated by Svelte v3.38.2 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 55, 4, 848);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$3, 56, 4, 869);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$3, 57, 4, 890);
    			add_location(div0, file$3, 54, 2, 838);
    			add_location(div1, file$3, 59, 2, 922);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$3, 53, 0, 814);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Product> was created with unknown prop '${key}'`);
    	});
    ...
    class Product extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*title*/ ctx[0] === undefined && !("title" in props)) {
    			console_1$1.warn("<Product> was created without expected prop 'title'");
    		}

    		if (/*price*/ ctx[1] === undefined && !("price" in props)) {
    			console_1$1.warn("<Product> was created without expected prop 'price'");
    		}

    		if (/*description*/ ctx[2] === undefined && !("description" in props)) {
    			console_1$1.warn("<Product> was created without expected prop 'description'");
    		}
    	}
    ...
    /* src\Cart\CartItem.svelte generated by Svelte v3.38.2 */

    const { console: console_1 } = globals;
    const file$2 = "src\\Cart\\CartItem.svelte";

    // (61:2) <Button mode="outline" on:click={displayDescription(id)}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:2) <Button mode=\\\"outline\\\" on:click={displayDescription(id)}>",
    		ctx
    	});
    ...
    // (64:2) <Button on:click={removeFromCart(id)}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(64:2) <Button on:click={removeFromCart(id)}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 65, 4, 1496);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(65:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	button0.$on("click", function () {
    		if (is_function(/*displayDescription*/ ctx[5](/*id*/ ctx[2]))) /*displayDescription*/ ctx[5](/*id*/ ctx[2]).apply(this, arguments);
    	});
    	...
    	button1.$on("click", function () {
    		if (is_function(/*removeFromCart*/ ctx[6](/*id*/ ctx[2]))) /*removeFromCart*/ ctx[6](/*id*/ ctx[2]).apply(this, arguments);
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 58, 2, 1230);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$2, 59, 2, 1249);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$2, 57, 0, 1223);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function displayDescription(id) {
    		...
    		const unsubscribe = products.subscribe(prods => {
    			$$invalidate(4, description = prods.find(product => product.id === id).description);
    		});
    ...
    class CartItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { title: 0, price: 1, id: 2 });
    ...
    /* src\Cart\Cart.svelte generated by Svelte v3.38.2 */
    const file$1 = "src\\Cart\\Cart.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 49, 6, 861);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (47:4) {#each $cartItem as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$cartItem*/ 1) cartitem_changes.id = /*item*/ ctx[1].id;
    			if (dirty & /*$cartItem*/ 1) cartitem_changes.title = /*item*/ ctx[1].title;
    			if (dirty & /*$cartItem*/ 1) cartitem_changes.price = /*item*/ ctx[1].price;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:4) {#each $cartItem as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 44, 2, 712);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$1, 45, 2, 728);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$1, 43, 0, 700);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $cartItem;
    	validate_store(cart, "cartItem");
    	component_subscribe($$self, cart, $$value => $$invalidate(0, $cartItem = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ onDestroy, CartItem, cartItem: cart, $cartItem });
    	return [$cartItem];
    }
    ...
    /* src\Products\Products.svelte generated by Svelte v3.38.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 29, 2, 507);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 28, 0, 495);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (12:0) <Button on:click={() => showCart = !showCart}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:0) <Button on:click={() => showCart = !showCart}>",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Cart, Products, Button, timer, showCart });

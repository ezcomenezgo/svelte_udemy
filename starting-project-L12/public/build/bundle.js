...
var app = (function () {
    ...
    /* src/Spring.svelte generated by Svelte v3.38.2 */
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 81, 6, 1379);
    			this.first = div;
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 79, 2, 1313);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 78, 0, 1292);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*cubicIn, discard, boxes, console*/ 20) {
    				each_value = /*boxes*/ ctx[2];
    				validate_each_argument(each_value);
    				group_outros();
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-1s55782");
    			add_location(div, file, 63, 4, 1250);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:2) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showParagraph*/ ctx[1] && create_if_block_1(ctx);
    	let if_block1 = /*showParagraph*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 49, 0, 955);
    			add_location(hr, file, 55, 0, 1109);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 57, 0, 1115);
    			add_location(button1, file, 58, 0, 1156);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const introstart_handler = () => console.log("Adding the element start");
    	const introend_handler = () => console.log("Adding the element starts");
    	const outrostart_handler = () => console.log("Removing the element start");
    	const outroend_handler = () => console.log("Removing the element starts");

...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<FamilyNode> was created with unknown prop '${key}'`);
    	});
    ...
    // (63:2) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:2) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 52, 0, 1219);
    			add_location(button1, file, 54, 2, 1287);
    			attr_dev(div, "class", "high svelte-sw2wk7");
    			add_location(div, file, 53, 0, 1266);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(document.body, "mouseenter", /*mouseenter_handler*/ ctx[6], false, false, false),
    					listen_dev(button0, "click", /*switchTitle*/ ctx[5], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (switch_value !== (switch_value = /*renderedComponent*/ ctx[2].cmp)) {
    				if (switch_instance) {
    					group_outros();
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function switchTitle() {
    		$$invalidate(1, title = "A new title");
    	}

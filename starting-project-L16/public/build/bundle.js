...
var app = (function () {
    ...
    /* src/Product.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 5, 0, 55);
    			add_location(button, file$3, 6, 0, 72);
    		},
    ...
    /* src/CartItem.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 5, 0, 55);
    			add_location(button, file$2, 6, 0, 72);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/FamilyNode.svelte generated by Svelte v3.38.3 */
    ...
    // (10:2) {#each member.children as child}
    function create_each_block$1(ctx) {
    	let familynode;
    	let current;

    	familynode = new FamilyNode({
    			props: { member: /*child*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*member*/ 1) familynode_changes.member = /*child*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:2) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let hr;
    	let current;
    	let if_block = /*member*/ ctx[0].children && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			hr = element("hr");
    			add_location(h1, file$1, 6, 0, 80);
    			add_location(hr, file$1, 13, 0, 212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { member } = $$props;
    	console.log(member, member.children);
    	const writable_props = ["member"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<FamilyNode> was created with unknown prop '${key}'`);
    	});
    ...
    class FamilyNode extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*member*/ ctx[0] === undefined && !("member" in props)) {
    			console_1.warn("<FamilyNode> was created without expected prop 'member'");
    		}
    	}
    ...
    // (40:0) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	let familynode;
    	let current;

    	familynode = new FamilyNode({
    			props: { member: /*familyMember*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:0) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	var switch_value = /*renderedComponent*/ ctx[0].cmp;

    	function switch_props(ctx) {
    		return {
    			props: {
    				title: /*renderedComponent*/ ctx[0].title,
    				id: /*renderedComponent*/ ctx[0].id
    			},
    			$$inline: true
    		};
    	}
    	...
    	let each_value = /*familyStructure*/ ctx[1];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(button, file, 31, 0, 754);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*renderedComponent*/ 1) switch_instance_changes.title = /*renderedComponent*/ ctx[0].title;
    			if (dirty & /*renderedComponent*/ 1) switch_instance_changes.id = /*renderedComponent*/ ctx[0].id;

    			if (switch_value !== (switch_value = /*renderedComponent*/ ctx[0].cmp)) {
    				if (switch_instance) {
    					group_outros();
    			...
    			if (dirty & /*familyStructure*/ 2) {
    				each_value = /*familyStructure*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function toggle() {
    		if (renderedComponent.cmp === Product) {
    			$$invalidate(0, renderedComponent = {
    				cmp: CartItem,
    				title: "Test CartItem",
    				id: "p2"
    			});
    	...
    	$$self.$inject_state = $$props => {
    		if ("familyStructure" in $$props) $$invalidate(1, familyStructure = $$props.familyStructure);
    	...
    	return [renderedComponent, familyStructure, toggle];
    }
